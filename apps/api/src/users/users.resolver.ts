...
import { CurrentUser, MainAuthGuardGuard, SecurityActions, UserSecurity } from "@food-delivery-mono/app-security";
...
export class UsersResolver {
  ...
  @Query(() => Users, { name: "currentUser" })
  @UseGuards(MainAuthGuardGuard, AccessGuard)
  @UseAbility(SecurityActions.readOne, Users)
  currentUser(@CurrentUser() currentUser: UserSecurity) {
